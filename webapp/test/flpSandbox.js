		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "JPC Submission Form Templates",
									"targetURL": "#comsapjpcsubmissionforms-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapjpcsubmissionforms-display": {
								"semanticObject": "comsapjpcsubmissionforms",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.jpcsubmissionforms",
									"url": sap.ui.require.toUrl("com/sap/jpcsubmissionforms")
								}
							}
						}
					}
